...
[![Every agent](https://img.shields.io/badge/Claude%20%7C%20Codex%20%7C%20Cursor%20%7C%20Gemini-black.svg)](#全ai全os)
...
> 技術的な完全分類・深刻度・残余リスク:
> [references/threat-model.md](skills/komainu/references/threat-model.md)
...
> 詳細・判定後の対処・隔離からの復元・環境変数: [docs/how-it-works.md](skills/komainu/docs/how-it-works.md)
...
| 層 | 対象 | 強度 |
|---|---|---|
| **PATH shim** | シェルを使う*あらゆる*AI — Claude Code / Codex / Cursor / Aider / Gemini CLI / 人間 — mac/Linux（Windows は PowerShell） | 強 / 決定論的 |
| **Claude Code hook** | Claude Code 内の Bash clone | 強 / 決定論的 |
| **routing スニペット** | Codex / Cursor / Gemini を各設定で誘導 | 助言的 |
...
**Claude 以外（Codex / Cursor / Gemini）でも動く?** はい。PATH shim がシェルを使う
あらゆる AI をカバーし、各 routing スニペットもあります。
...
続き: [docs/faq.md](skills/komainu/docs/faq.md)
...
| [docs/how-it-works.md](skills/komainu/docs/how-it-works.md) | 10フェーズ・カテゴリ・強制層・判定対処・環境変数 |
| [docs/faq.md](skills/komainu/docs/faq.md) | よくある質問 |
| [references/threat-model.md](skills/komainu/references/threat-model.md) | 脅威分類と残余リスクの完全版 |
| English | [README.md](README.md) · [docs/index.md](skills/komainu/docs/index.md) |

...
> variables: [docs/how-it-works.md](skills/komainu/docs/how-it-works.md)
...
More: [docs/faq.md](skills/komainu/docs/faq.md)
...
| [docs/how-it-works.md](skills/komainu/docs/how-it-works.md) | 10-phase lifecycle, categories, enforcement, verdict handling, env vars |
| [docs/faq.md](skills/komainu/docs/faq.md) | Common questions |
| [references/threat-model.md](skills/komainu/references/threat-model.md) | Full threat taxonomy & residual-risk analysis |
| 日本語 | [README.ja.md](README.ja.md) · [docs/index.ja.md](skills/komainu/docs/index.ja.md) |
